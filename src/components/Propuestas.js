...
class Propuestas extends React.Component{
  ...
  render(){
    ...
    <div>
        ...
        <h2 style={{textAlign:"justify"}}>Nuestras Propuestas Principales</h2>
        ...
        <h2 style={{textAlign:"justify"}}>Feedback continuo</h2>
        ...
        <h2 style={{textAlign:"justify"}}>Reconocimiento</h2>
        ...
        <h2 style={{textAlign:"justify"}}>Clubes</h2>
        ...
        <h2 style={{textAlign:"justify"}}>Eventos conjuntos con otros colegios</h2>
